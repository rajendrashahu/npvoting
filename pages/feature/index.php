    ...
    <div class="container">
        ...
        <div>
            ...
            <div>
                <h3>Key Features</h3>
                <div>
                    <h6>20-inch monitor </h6>
                    <p>A large touch screen features a replica of the ballot allowing a simple and smooth experience.</p>
                </div>

                <div>
                    <h6>Self-operated Battery</h6>
                    <p>20 Wh battery allows 12 hrs of uninterrupted power supply in case of a power outage.</p>
                </div>

                <div>
                    <h6>Voter-verified paper trail</h6>
                    <p>While the vote is being cast, the machine prints a paper simultaneously to keep the record for manual counting.</p>
                </div>

                <div>
                    <h6>Source code review</h6>
                    <p>Source code security analysis has been conducted on its software to detect any vulnerabilities.</p>
                </div>

                <div>
                    <h6>Protected data</h6>
                    <p>A government-issued digital signature protects all of its data, removing any doubt of data manipulations.</p>
                </div>

                <div>
                    <h6>Intellectual rights</h6>
                    <p>RL Innovations owns the copyright of the software and are in the process of obtaining the patent on the apparatus.</p>
                </div>
                <div>
                    <p> <i>All the data are referenced from the 2017 elections data.</i> </p>
                </div>
            </div>
